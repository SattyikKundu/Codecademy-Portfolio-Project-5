// U.S. state and territory options for grouped dropdown menu in Profile Page
// for editing shipping delivery state.
...
export const highShippingCostStates = ['AK','HI','AS','GU','MP','PR','VI'];

export const lowShippingCostStates = [
